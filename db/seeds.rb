...
JobProfile.create!(user: user1, name: "Chef de chœur"                               , artist: true, executive: true, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Maître de ballet"                            , artist: true, executive: true, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Metteur en scène"                            , artist: true, executive: true, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Orchestrateur"                               , artist: true, executive: true, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Artiste du cirque"                           , artist: true, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Artiste de comédies musicales"               , artist: true, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "DJ"                                          , artist: true, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Danseur/danseuse de revue"                   , artist: true, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Conteur/conteuse"                            , artist: true, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Architecte décorateur"                       , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Chargé de production"                        , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Coiffeur"                                    , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Concepteur artificier"                       , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Eclairagiste"                                , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Concepteur lumière"                          , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Concepteur du son"                           , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Ingénieur du son"                            , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Constructeur de décor"                       , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Directeur de production"                     , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Directeur technique"                         , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Dramaturge"                                  , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Électricien"                                 , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Ensemblier"                                  , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Habilleur"                                   , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Lingère"                                     , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Repasseuse"                                  , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Machiniste"                                  , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Menuisier"                                   , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Monteur de structure"                        , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Monteur son"                                 , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Opérateur lumière"                           , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Opérateur son"                               , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Preneur de son"                              , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Peintre de décors"                           , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Peintre décorateur"                          , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Perruquier"                                  , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Poursuiteur"                                 , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien prompteur"                        , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Réalisateur costumes"                        , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Réalisateur lumière"                         , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Réalisateur son/sonorisateur"                , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur"                                   , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur de production"                     , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur de chœur"                          , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur de scène"                          , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur lumière"                           , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur plateau"                           , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Régisseur son"                               , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Répétiteur/souffleur"                        , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Rigger"                                      , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Scénographe"                                 , artist: false, executive: true,  contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Tailleur/couturier"                          , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien CAO-PAO"                          , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien hydraulique"                      , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Cariste de spectacles"                       , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien instruments de musique (backline)", artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien son"                              , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
JobProfile.create!(user: user1, name: "Technicien HF"                               , artist: false, executive: false, contributions_list: "[#{c10.id}, #{c11.id}, #{c12.id}, #{c13.id}, #{c14.id}, #{c15.id}, #{c29.id}, #{c09.id}, #{c07.id}, #{c16.id}, #{c08.id}]")
