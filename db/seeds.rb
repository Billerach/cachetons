...
jp_artiste_c_5 =  JobProfile.create!(user: user1, artist:true, executive: true, name:"Chorégraphe")
jp_artiste_c_6 =  JobProfile.create!(user: user2, artist:true, executive: true, name:"Directeur(trice) musical")
jp_artiste_c_7 =  JobProfile.create!(user: user2, artist:true, executive: true, name:"Dramaturge")
jp_artiste_c_8 =  JobProfile.create!(user: user2, artist:true, executive: true, name:"Chef d'orchestre")
jp_artiste_c_9 =  JobProfile.create!(user: user2, artist:true, executive: true, name:"Notateur(trice) / reconstructeur(trice)")
jp_artiste_c_10 = JobProfile.create!(user: user2, artist:true, executive: true, name:"Chef de chant")
jp_artiste_c_11 = JobProfile.create!(user: user2, artist:true, executive: true, name:"Arrangeur musical")
...
jp_artiste_nc_6  = JobProfile.create!(user: user1, artist:true, executive: :false, name:"Artistes musiciens appartenant aux ensembles musicaux SANS nomenc_lature")
jp_artiste_nc_7  = JobProfile.create!(user: user1, artist:true, executive: :false, name:"Artistes musiciens appartenant au secteur des musiques actuelles")
jp_artiste_nc_8  = JobProfile.create!(user: user1, artist:true, executive: :false, name:"Artistes musiciens engagés au sein d'autres entreprises")
jp_artiste_nc_9  = JobProfile.create!(user: user1, artist:true, executive: :false, name:"Artistes de choeur")
jp_artiste_nc_10 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Artistes de cirque")
jp_artiste_nc_11 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Conseiller(ère) musical(e) et/ou chorégraphique")
jp_artiste_nc_12 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Conseiller(ère) en programmation")
jp_artiste_nc_13 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Accompagnant(e) musical(e)")
jp_artiste_nc_14 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Répétiteur(trice) musical(e)")
jp_artiste_nc_15 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Répétiteur(trice) chorégraphique")
jp_artiste_nc_16 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Artiste lyrique des chœurs")
jp_artiste_nc_17 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"Artiste soliste lyrique")
jp_artiste_nc_18 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"DJ")
jp_artiste_nc_19 = JobProfile.create!(user: user2, artist:true, executive: :false, name:"VJ")
...
jp_non_artiste_c_5 =  JobProfile.create!(user: user1, artist:false, executive: :true, name:"Régisseur d’orchestre")
jp_non_artiste_c_6 =  JobProfile.create!(user: user1, artist:false, executive: :true, name:"Régisseur de scène/Régisseur d’équipement scénique")
jp_non_artiste_c_7 =  JobProfile.create!(user: user1, artist:false, executive: :true, name:"Régisseur lumière")
jp_non_artiste_c_8 =  JobProfile.create!(user: user1, artist:false, executive: :true, name:"Régisseur plateau son (retours)")
jp_non_artiste_c_9 =  JobProfile.create!(user: user2, artist:false, executive: :true, name:"Régisseur son")
jp_non_artiste_c_10 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Réalisateur coiffure, perruques")
jp_non_artiste_c_11 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Réalisateur costumes")
jp_non_artiste_c_12 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Réalisateur lumière")
jp_non_artiste_c_13 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Réalisateur maquillages, masque")
jp_non_artiste_c_14 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Réalisateur son")
jp_non_artiste_c_15 = JobProfile.create!(user: user2, artist:false, executive: :true, name:"Scénographe")
...
Payslip.create!(payslip_number: 1, employee_id: fabrice.id,   company_id: company2.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: la_Déglingue.id,      job_profile_id: jp_artiste_nc_12.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
Payslip.create!(payslip_number: 1, employee_id: mamadou.id,   company_id: company3.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: mais_oui_mais_non.id, job_profile_id: jp_artiste_c_1.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
Payslip.create!(payslip_number: 1, employee_id: luke.id,      company_id: company1.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: to_be.id,             job_profile_id: jp_artiste_c_3.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
Payslip.create!(payslip_number: 1, employee_id: albert.id,    company_id: company2.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: la_Déglingue.id,      job_profile_id: jp_artiste_c_7.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
Payslip.create!(payslip_number: 1, employee_id: luke2.id,     company_id: company3.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: mais_oui_mais_non.id, job_profile_id: jp_non_artiste_c_4.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
Payslip.create!(payslip_number: 1, employee_id: albert2.id,   company_id: company3.id, contract_start: "2018-01-12", contract_end: "2018-01-13", payment_date: "2018-01-17", performance_id: mais_oui_mais_non.id, job_profile_id: jp_non_artiste_c_14.id, hours_per_day: 8, executive: false, allowance: 1, basis: 212.00, basis_per_day: 106.00, allowance_basis: 212.00, number_of_hours: 16, employer_s_contribution: 115.09, employee_s_contribution: 52.77, net_salary: 159.23, taxable_net: 165.30, urssaf_limit: 400.00, employer_cost: 286.68, number_of_performance: 0, number_of_rehearsal: 0, gross_salary_accumulation: 138, taxable_net_accumulation: 109.93, net_accumulation: 105.98, urssaf_limit_accumulation: 288.00, employer_cost_accumulation: 214.20, hours_accumulation: 12, artist: false)
